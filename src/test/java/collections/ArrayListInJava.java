...
public class ArrayListInJava {
	...
	// Example of adding different kind of elements without specifying generic
	// type
	public static void method1() {
		// Since we have not specified generic type we can store any type of
		// data
	...
	public static void method2() {
		// Here we have specified generic type as Integer. We cannot use
		...
		list.add(30);
		list.add(65);
		// list.add(true); //Error: The method add(Integer) in the type
		// List<Integer> is not applicable for the arguments (boolean)
	...
	public static void method3() {
		...
		// If I want to add the data of one array list to another array list use
		// addAll()
		list1.addAll(list2);
	...
	// We can add different types of elements to list if the generic type is
	// Object
	...
	// retainAll() - compares list1, list2 and retains matching elements in
	// list1
	...
	// containsAll() - check if list2 elements are present in list1 and returns
	// boolean value
	...
	// contains() - used to find if an element is present in list - returns
	// boolean value
	...
	//We cannot create an object of list as it is an interface
